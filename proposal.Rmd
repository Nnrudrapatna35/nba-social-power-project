...
The linear model is: -32.916 + 0.204 * `AGE` + 0.101 * `OFF_RATING` + 0.093 * `DEF_RATING` + 36.489 * `PIE` + 1.835 * `REB_PCT` - 1.06 * `USG_PCT` + 0.144 * `SALARY_MILLIONS` + 3.131 * `W_PCT`.
