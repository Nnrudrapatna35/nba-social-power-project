...
To more precisely determine whether LeBron James is an influential point, we will look at standardized residuals, leverage, and Cook's Distance:
...
*use model without LeBron (m_final_LJ)
