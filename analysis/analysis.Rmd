...
*use final model without LeBron (`m_final_noLJ`)
*nba_social_power_mod2 (without LeBron, 94 observations)
*5 missing observations due to players not having Twitter handles, describe why we choose to remove using missing data lecture stuff
*use standardized residuals for the plot of the residuals vs. predictors and for the histogram and normal QQ-plot of residuals
