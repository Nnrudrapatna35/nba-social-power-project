...
One other modification we have made to our original dataset is removing LeBron James. We decided, based on Cook's distance, standardized residuals, and leverage, LeBron was an influential point with a significant effect on the regression line. Consequently, we removed LeBron to avoid overestimation in our model.
...
```{r}
ggplot(data = nba_social_power_mod2, mapping = aes(x = resid)) + geom_histogram() + labs(title = "Distribution of Residuals",
                                                                                         x = "Residuals",
                                                                                         y = "Count")
```
